...
const DhId = () => {
  ...
  const imageUrls = [
    { src: "/images/dhfs (6).webp", alt: "Atlantis Project 20", title: "Atlantis Project 20" },
    { src: "/images/dhfs (3).webp", alt: "Atlantis Project 21", title: "Atlantis Project 21" },
    { src: "/images/dhfs (4).webp", alt: "Atlantis Project 22", title: "Atlantis Project 22" },
    { src: "/images/dhfs (5).webp", alt: "Atlantis Project 23", title: "Atlantis Project 23" },
