...
const images = [
  '/images/apartment-window-sitting-interior-design-business-bay.png',
  '/images/apartment-kitchen-interior-design-business-bay.png',
  '/images/luxury-dinning-area-apartment-interior-design-business-bay.png',
];
  ...
  return (
    <section className="py-10 px-6 bg-black-200">
      <h2 className="text-center text-white text-xs sm:text-xl md:text-xl font-conthrax tracking-widest mb-6 uppercase">
        We Do Apartment Interior Design Business Bay
      </h2>
