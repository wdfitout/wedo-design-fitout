...
const testimonials = [
  {
    text: `"WE DO Interior Design & Fit-Out transformed our space into exactly what we had imagined. The team handled every detail from approvals to the final styling, delivering top-tier interior design services in Dubai Creek Harbour. Their professionalism and transparency throughout the project were absolutely remarkable."`,
    author: "— Malik A., Dubai Creek Harbour Resident"
  },
  {
    text: `"Excellent residential fit-out services! They perfectly optimized our waterfront layout, making it functional yet highly elegant. If you are looking for premium interior design services in Dubai Creek Harbour, WE DO is definitely the most efficient and creative choice."`,
    author: "— S. Khan, Project Owner"
  },
  {
    text: `"Choosing WE DO for our interior design and styling was the best decision. They navigated the complex approvals smoothly and brought our design vision to life with perfect craftsmanship. Truly one of the best interior design companies in the area."`,
    author: "— R. Ahmed, Commercial Client"
  }
];
...
<div className="bg-[#111111] p-6 sm:p-10 rounded-2xl border-l-4 border-[#b98877] my-12 font-play text-white relative overflow-hidden">
  <h2 className="text-xl font-conthrax text-[#b98877] uppercase tracking-wider mb-6">
    What Our Clients Say About Our Creek Harbour Services
  </h2>
  ...
  <div className="relative flex items-center justify-between gap-4 md:gap-8">
    ...
    <button 
      ...
      className="p-2 rounded-full border border-gray-600 text-gray-400 hover:text-black hover:bg-[#b98877] hover:border-[#b98877] transition duration-300 flex-shrink-0 z-20"
    ...
    <div className="relative min-h-[160px] sm:min-h-[100px] flex flex-col justify-between flex-grow">
      {testimonials.map((slide, index) => (
        <div
          key={index}
          className={`transition-opacity duration-500 space-y-3 ${
        ...
        >
          ...
          <span className="block text-right text-xs font-conthrax text-[#b98877] mt-2">
            {slide.author}
          </span>
        </div>
      ))}
    ...
    {testimonials.map((_, index) => (
      <button
        ...
        className={`h-2 w-2 rounded-full transition-all duration-300 ${
          index === currentSlide ? "bg-[#b98877] w-5" : "bg-gray-600"
        }`}
      />
    ))}
  </div>
</div>
{/* ================= END Creek Harbour TESTIMONIALS SECTION ================= */}
