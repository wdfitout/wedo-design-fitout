...
const TestimonialCarousel = () => {
  const testimonials = [
   {
  quote: "WE DO Interior Design & Fit-Out transformed our restaurant in Volante Tower into a luxurious residence that perfectly captures the energy of Business Bay. The team handled every aspect from concept design to final styling with exceptional professionalism.",
  author: "A.K., Volante Tower, Business Bay",
},
{
  quote: "Our restaurant overlooking Dubai Canal now feels like a five-star private residence. WE DO managed the complete fit-out process seamlessly and delivered exactly what was promised.",
  author: "S.M., Peninsula Business Bay",
},
{
  quote: "The team created a sophisticated restaurant interior that maximizes our Burj Khalifa views while maintaining comfort and practicality. Communication and project management were outstanding throughout.",
    ...
    <section className="px-6 py-5 bg-black-200">
      ...
      <div className="lg:max-w-[80%] mx-auto bg-black p-6 sm:p-10 rounded shadow text-center space-y-6 mb-12">
        <h2 className="text-sm sm:text-xl md:text-xl tracking-widest font-conthrax text-[#caa193]">
          restaurant Interior Design Services in Business Bay
        </h2>
        <div className="space-y-4 text-sm sm:text-base font-play text-white text-left">
          <p className="text-justify">
            At WE DO Interior Design & Fit-Out, our restaurant interior design Business Bay services are built around one principle, every decision should serve the space, the view, and the way you live. Here is what we deliver for every Business Bay restaurant project.
          </p>
          <ul className="space-y-4 text-[#caa193]">
            ...
            <li>
              ...
              <p className="text-white font-play text-sm sm:text-base text-justify"> Even before ordering a single item or putting a hand to any walls, you get to see your dream restaurant come alive in photorealistic 3D visualization. Where Business Bay restaurant interior design services are concerned, this is an absolute must.</p>
            </li>
            <li>
              <h3 className="font-play font-bold text-base text-justify">Turnkey Fit-Out & Project Management:</h3>
              <p className="text-white font-play text-sm sm:text-base text-justify"> From civil works, floorings, ceilings, MEP coordination, to painting, styling, and snagging, everything is handled by a separate project manager right from the very beginning until completion. This is how Modern restaurant Interior Design Dubai Services should be.</p>
            </li>
          </ul>
        </div>
      </div>
      ...
      {/* Split Row – Text + Top Right Image */}
       <div className="max-w-7xl mx-auto">
        <h2 className="text-center text-3xl font-conthrax text-white py-12">
          What Makes Business Bay restaurant Interiors Unique
        </h2>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center mb-16">
          <div className="space-y-6 text-white font-play">
            <p className="text-justify">
              Approvals – this is the issue that pops up more often than any other when we discuss restaurant interior designers in Dubai. Approvals involve paperwork, waiting, and fear of making mistakes. But our answer is simple and straightforward, WE DO deal with everything on your behalf. This is how we do approvals for a restaurant interior design in Business Bay:
            </p>
            <ul className="list-decimal pl-5 space-y-4 text-[#caa193]">
              <li>
      ...
      <div className="lg:max-w-[90%] mx-auto bg-black p-6 sm:p-10 rounded shadow space-y-6 mb-12 mt-12">
        <div className="text-center">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-conthrax text-[#caa193] mb-2">
            Why Dubai's restaurant Owners Choose WE DO Interior Design & Fit-Out
          </h2>
          <p className="font-play text-sm sm:text-base text-white text-justify py-2 leading-relaxed">
            Being the best restaurant <b className="text-[#caa193]"><a href="/interior-design-dubai-creek-harbour">interior design company in Business Bay</a></b>. WE DO offers you the assurance not just in words but also backed up by completed projects in Palm Jumeirah, Downtown, DIFC and the latest addition is the Business Bay. All of your requirements related to design, custom joinery manufacture, procurement and project management are carried out under one umbrella in our Jebel Ali premises. WE DO will not subcontract any critical activities and no surprise in terms of quality and time of delivery. Given the extensive experience in designing restaurants in Dubai in the best addresses of the city, our team has expertise that general interior design companies lack in dealing with restaurants. Our designers know what fits best in your restaurant. Each project in your restaurant is managed by a single project manager throughout the entire process from start to completion. One contact number is enough for all of your requirements. All the Dubai restaurant interiors which fall within the size range of 3,500 to 5,500 square feet can be finished in a time frame of 12 - 18 weeks. All the fit outs provided by WE DO come with a one year warranty on all joineries and fittings.<br /><br />
      ...
      <div className="lg:max-w-[80%] mx-auto flex flex-col lg:flex-row items-start gap-6 mb-12">
        <div className="w-full space-y-4">
          ...
          <p className="text-sm sm:text-base text-white text-justify font-play">
            Our company <b className="text-[#caa193]"><a href="https://wedointerior.ae/office-interior-design-dubai">WE DO Interior Design & Fit-Out</a></b> provides restaurant interior design in Business Bay and beyond to the entire eastern side of Dubai, which includes Downtown Dubai, Business Bay, DIFC, Dubai Festival City, and Ras Al Khor. Our team can reach your property within 24 hours from the time you call us if your property is situated in or near Business Bay.
          </p>
          {/* Map Embed */}
<div className="w-full rounded-lg overflow-hidden my-4" style={{ height: "350px" }}>
  ...
  ></iframe>
          ...
          <h3 className="text-base md:text-sm font-conthrax text-[#caa193] pt-2 text-justify">
            How much does restaurant interior design cost in Business Bay?
          </h3>
          <p className="text-sm sm:text-base text-white text-justify font-play">
            restaurant interior design in Business Bay cost will depend on the size of your restaurant unit, the type of job required, and the material quality chosen. restaurant fit-out costs in Business Bay can vary from AED 350,000 for a standard turnkey service up to AED 900,000+ for larger units. We give you a clear itemised quote after the first site visit – never rough estimates.
          </p>

          <h3 className="text-base md:text-sm font-conthrax text-[#caa193] pt-2 text-justify">
            How long does a full restaurant fit-out take in Business Bay?
          </h3>
          <p className="text-sm sm:text-base text-white text-justify font-play">
            The duration of a typical restaurant interior design Business Bay service, involving complete interior design, custom joinery manufacture, and furniture procurement, will be between 12-18 weeks, beginning from design approval of. This includes the Emaar approval period. Larger or more complex projects, cinema rooms, rooftop kitchens, structural changes may extend to 20–22 weeks. All timelines are written into the contract.
          </p>
          ...
          <p className="text-sm sm:text-base text-white text-justify font-play">
            Yes. Every restaurant interior design project at WE DO begins with a full 3D photorealistic render of all key spaces before any work begins or any item is ordered. For Business Bay restaurant interiors where the relationship between the interior and the view is central to the design, we consider visualization a non-negotiable step.
          </p>

          <h3 className="text-base md:text-sm font-conthrax text-[#caa193] pt-2 text-justify">
            Can you work on a restaurant that is already occupied or furnished?
          </h3>
          <p className="text-sm sm:text-base text-white text-justify font-play">
            Yes. We have delivered restaurant renovation projects in occupied units across Dubai, working in phased sequences one zone at a time to allow residents to remain in the property. This requires a more detailed programme and additional site management, which we plan for at the outset.
          </p>

          <h3 className="text-base md:text-sm font-conthrax text-[#caa193] pt-2 text-justify">
            Which restaurant buildings in Business Bay have you worked in?
          </h3>
          <p className="text-sm sm:text-base text-white text-justify font-play pb-6">
            In our restaurant Projects in Business Bay, we have carried out fit-out in The Cove, Harbour Views, Creek Gate, and Island Park. We know the rules regarding the particular fit-out in each of the towers. If your building is not listed, contact us. Our team will research the specific requirements before your first meeting.
          </p>
          ...
          <div className="pt-6 border-t border-gray-800">
            <h2 className="text-sm sm:text-xl md:text-xl tracking-widest font-conthrax text-[#caa193] mb-2 text-justify">
              Start Your Business Bay restaurant Project
            </h2>
            <p className="text-sm sm:text-base text-white text-justify font-play">
              Your Business Bay restaurant deserves a design that matches the address. WE DO Interior Design & Fit-Out offers a free site visit and initial concept consultation, no obligation, no generic presentation. Tell us your building, your size, and your vision. We handle the rest.
            </p>
          </div>
        </div>
      </div>
