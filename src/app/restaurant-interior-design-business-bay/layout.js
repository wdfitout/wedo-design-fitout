...
export const metadata = {
  title: "restaurant Interior Design Business Bay - WE DO",
  description:
    " Luxury restaurant interior design in Business Bay. Bespoke fit-out, Emaar approvals handled, 3D visualization included. View our restaurant projects.",
