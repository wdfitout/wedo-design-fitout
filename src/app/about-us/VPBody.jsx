      ...
      <div className="mb-0">
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="w-full lg:w-1/2 space-y-4 text-sm leading-6 text-white/90 font-play">
            <p>
              We Do design is a top-notch company that was established in 2013 by Hamza Jamal Alatta. The company manufactures and delivers the best services of interior designing products. We offer the <b className="text-[#caa193]"
