...
const DProjects = () => {
  return (
    <section className="px-6 py-10 bg-black-200">
      ...
      <div className="lg:max-w-[60%] mx-auto bg-black p-6 sm:p-10 rounded shadow text-center space-y-6 mb-12">
        ...
        Why Choose WE DO for Your Villa Interior Design Dubai?
        </h2>
 ...
 <p>
  ...
  the reputation as one of the best interior design and fit out companies in Dubai.
</p>
      ...
      <div className="bg-[#f5ede5] py-10 text-center space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center mb-16">
          <div className="space-y-6 text-white font-play">
            ...
            <li>
             <p className='text-white font-play'><b> Interior Fit Out in Dubai – </b>Complete premium fit-out, ensuring perfect execution of design vision </p>
            </li>
            <li>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-6 text-white font-play">
            ...
            <p>
              In the era of 2026, the demand for Smart home integration continues to grow. We use voice-activated systems,  
              climate control and advanced lighting for fully automated living experience.
              </p>
          </div>
        </div>
      </div>
       ...
       <p className="font-play text-sm sm:text-base text-white"> Once approved, we proceed with premium 
        ...
        <div>
          ...
          <p className="font-play text-sm sm:text-base text-white">
           So, are you ready to transform your villa into a true masterpiece? <b className="text-[#caa193]"><a href="https://wedointerior.ae/contact-us">Contact WE DO Interior Design & Fitout </a></b>for a
           free consultation and take the first step toward your dream villa design. Give us a chance to show you why 
