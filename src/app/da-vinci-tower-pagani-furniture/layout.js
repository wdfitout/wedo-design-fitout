...
export const metadata = {
  title: "Furniture Supply for Da Vinci Tower By Pagani, Dubai",
  description:
    "Your Da Vinci Tower residence is handed over unfurnished. WE DO designs, builds and installs custom furniture for Business Bay apartments. Call Now",
