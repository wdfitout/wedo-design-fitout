...
export const metadata = {
  ...
  description:
    "Transform your Creek Harbour property with premium custom made furniture, wardrobes, & kitchen cabinetry. 11+ years of bespoke in-house joinery excellence in Dubai.",
