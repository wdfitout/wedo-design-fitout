      ...
      <div className="lg:max-w-[80%] mx-auto">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-start">
            ...
            <p className="text-sm sm:text-base leading-7 mb-4 font-play">
              Whether you are opening a new salon or renovating your previous one, our salon interior design ranging
              from <b className="text-[#caa193]"><a href="https://wedointerior.ae/dubai-hills-mall-facial-studio"> Dubai Hills Mall facial studios</a></b> to beauty lounges or <b><a href="https://wedointerior.ae/jumeirah-1-beauty-salon">beauty salons in Jumeirah 1</a></b>, Downtown Dubai, Palm Jumeirah, and Business
              Bay guarantees your business prospers. 
           </p>
