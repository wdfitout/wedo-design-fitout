...
const PjId = () => {
  ...
  const imageUrls = [
    { src: "/images/pjapt (5).webp", alt: "Atlantis Project 21", title: "Atlantis Project 21" },
    { src: "/images/pjapt (16).webp", alt: "Atlantis Project 22", title: "Atlantis Project 22" },
    { src: "/images/pjapt (3).webp", alt: "Atlantis Project 23", title: "Atlantis Project 23" },
    { src: "/images/pjapt (12).webp", alt: "Atlantis Project 24", title: "Atlantis Project 24" },
