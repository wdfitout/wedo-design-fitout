...
export const metadata = {
  ...
  description:
    "Expert cafe interior design in Dubai Creek Harbour. Custom concepts, space planning, 3D renders & full fitout. Trusted cafe fitout company in Dubai. Get a free quote today!",
