...
const DProjects = () => {
  return (
    <section className="px-6 py-5 bg-black-200">
          ...
          <div className="space-y-6 text-white font-play">
            ...
            <ul className="list-decimal pl-5 space-y-4 text-[#caa193]">
              <li>
                ...
                <p className="text-white font-play text-sm sm:text-base text-justify">We design spaces that elevate luxury goods, optimizing product placement and lighting to create an exclusive shopping experience that reflects premium brand values.</p>
              </li>
              <li>
                <h3 className="font-play font-bold text-base text-justify">Concept Stores & Speciality Retail</h3>
                <p className="text-white font-play text-sm sm:text-base text-justify">Tailored environments that emphasize brand storytelling, allowing experiential zones and creative fixture layouts to increase customer engagement and dwell time.</p>
              </li>
              <li>
                <h3 className="font-play font-bold text-base text-justify">Premium Showrooms</h3>
                <p className="text-white font-play text-sm sm:text-base text-justify">Expansive retail layouts optimized for furniture, electronics, or lifestyle brands, focusing on open spatial planning and realistic lifestyle staging settings.</p>
              </li>
              <li>
                <h3 className="font-play font-bold text-base text-justify">Turnkey Store Handover</h3>
                <p className="text-white font-play text-sm sm:text-base text-justify">Complete project delivery from initial shell-and-core approvals right up to custom millwork fabrication and merchandising display support.</p>
              </li>
            </ul>
            <p>WE DO start the design process before your keys arrive, so there is no gap between handover and the retail space going live.</p>
          </div>

          <div className="rounded-lg overflow-hidden shadow-md">
            <Image
              src="/images/dtrest (6).webp"
              alt="Retail fitout showroom interior design"
              width={600}
              height={400}
      ...
      {/* Why Retail Operators Choose Us Section */}
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center text-3xl font-conthrax text-white py-12 uppercase">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center mb-16">
          ...
          <div className="rounded-lg overflow-hidden shadow-md">
            <Image
              ...
              alt="Luxury storefront design and branding"
              width={600}
              height={400}
              className="w-full h-auto object-cover"
            />
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div className="rounded-lg overflow-hidden shadow-md">
            <Image
              ...
              alt="Premium retail boutique layout design"
              width={600}
              height={400}
              className="w-full h-auto object-cover"
            />
