...
const ApId = () => {
  ...
  return (
    <section className="bg-black text-white px-4 sm:px-10 md:px-16 lg:px-28 xl:px-40 py-10 sm:py-10 font-sans overflow-hidden">
      <p>August 28, 2026</p>
      <div className="w-full lg:max-w-[98%] mx-auto">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 lg:items-start">
          ...
          <div className="w-full lg:w-1/2 flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 mt-2">
              ...
              <Link
                ...
                className="border border-[#caa193] text-xs sm:text-base font-play px-6 py-4 w-full sm:w-fit uppercase rounded hover:bg-[#caa193] hover:text-black transition-all duration-200 text-center block"
              >
                GET YOUR QUOTE
              </Link>
            </div>
          ...
          <div className="w-full lg:w-1/2 flex flex-col space-y-4 mt-6 lg:mt-0">
            <h2 className="text-xs sm:text-xl md:text-xl font-conthrax tracking-widest text-gray-200 py-2 sm:mt-10">
