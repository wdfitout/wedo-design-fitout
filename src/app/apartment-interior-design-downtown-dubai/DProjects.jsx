        ...
        <div className="w-full space-y-4">
          ...
          <div className="pt-6 border-t border-gray-800">
            ...
            <p className="text-sm sm:text-base text-white text-justify font-play">
              ...
              Whether you want a home that genuinely feels like theirs, an investment property that tops the market, or a holiday apartment that earns five-star reviews, WE DO Interior Design & Fitout will make it happen.<br/>
