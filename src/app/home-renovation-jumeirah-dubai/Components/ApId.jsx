      ...
      <div className="lg:max-w-[90%] mx-auto">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full flex flex-col justify-start">
            ...
            <p className="text-sm sm:text-base leading-7 mb-4 font-play text-justify">
              This is when <b className="text-[#caa193]"><a href="https://wedointerior.ae/home-renovation-jumeirah-dubai">home renovation in Jumeirah Dubai</a></b> becomes part of your discussion, not to mention any single issue in particular but all the changes at once.
