        ...
        <div className="grid md:grid-cols-2 gap-10 items-center mb-16">
          <div className="space-y-6 text-white font-play">
            ...
            <p className="text-justify">
              ...
              Sometimes the biggest improvement to a home isn't new finishes, it's changing how the rooms relate to each other. Opening up a closed kitchen, removing a wall between two underused rooms, rethinking how the entrance flows into the rest of the house. As part of our broader villa <b className="text-[#caa193]"><a href="https://wedointerior.ae/interior-design-jumeirah-dubai">interior design Jumeirah</a></b> approach, we assess what's structurally possible early on, so the design and the reality line up from the start.
            </p>
            <p className="text-justify">
