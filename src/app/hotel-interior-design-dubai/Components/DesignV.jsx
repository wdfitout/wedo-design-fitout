...
const images = [
  '/images/Hotel Interior Designs Dubai.png',
  '/images/Hotel Interior Design company in Dubai.png',
   '/images/Hotel bathroom fitout dubai.png',
];
  ...
  return (
    <section className="py-10 px-6 bg-black-200">
      <h2 className="text-center text-white text-xs sm:text-xl md:text-xl font-conthrax tracking-widest mb-6 uppercase">
        We Do Hotel Design Related Services
      </h2>
