      ...
      <div className="lg:max-w-[80%] mx-auto">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-start">
            ...
            Hotel Interior Design Company in Dubai
            </h2>
            <p className="text-sm sm:text-base leading-7 mb-4 font-play">
            At WE DO Interior Design & Fitout, we are a well known leading hotel interior design company in Dubai, delivering the best spaces that match the standards of guests. From resort interior design Dubai and luxury hotel interiors to boutique hotel projects and business hotel interiors, we provide innovative, bespoke and trendy solutions. As the No.1 hotel interior design company in Dubai, our team combines creativity, technical expertise and cultural aspects to design immersive hotel environments that reflect the identity of a brand and maximize the best experience for guests</p>
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center items-start space-y-6">
            <h2 className="text-xs sm:text-xl md:text-xl font-conthrax tracking-widest text-gray-200">
              Get Best Hotel Interior Design Dubai
            </h2>
