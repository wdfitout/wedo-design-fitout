...
const DProjects = () => {
  return (
    <section className="px-6 py-5 bg-black-200">
      ...
      {/* Top Content Block */}
      {/* Jumeirah Apartments Have Their Own Character Section */}
    ...
    <p className="text-justify">
      ...
      <ul className="list-decimal pl-5 space-y-4 text-[#caa193]">
       <li>
         ...
         <p className="text-white font-play text-sm sm:text-base text-justify">TBefore starting any project, we take time to understand the household: who lives there, how the rooms get used through a normal week. A family with young children has very different requirements from a couple or someone who works from home most days. This conversation shapes everything that follows.</p>
       </li>
       <li>
...
></iframe>
          ...
          <p className="text-sm sm:text-base text-white text-justify font-play">
           he timeline for the transformation of your Jumeirah apartment depends fully on the scope of the job. A full makeover of everything is going to take from 6 to 10 weeks. When all you want to do is renovate one particular area, such as either the kitchen or bathroom, the entire renovation can usually be done in as little as 3 to 5 weeks.
          </p>
