...
const images = [
  '/images/villa-renovation-smart-home-dubai.png',
  '/images/villa-renovation-painting-dubai.png',
  '/images/villa-renovation-bathroom-dubai.png',
];
    ...
    <section className="py-10 px-6 bg-black-200">
      ...
      <div className="bg-[#f5ede5] py-10 text-center space-y-4">
        ...
        <p className="text-sm sm:text-base font-play">
         WE DO Interior Design & Fit-Out | Phone/WhatsApp: +971 58 807 5603 | Email: info@wedointerior.ae Free site visit, itemized breakdown by room.
        </p>
