...
const DmId = () => {
  ...
  const imageUrls = [
   { src: "/images/dmapt (6).webp", alt: "Atlantis Project 24", title: "Atlantis Project 24" },
   { src: "/images/dmapt (7).webp", alt: "Atlantis Project 24", title: "Atlantis Project 24" },
   { src: "/images/dmapt (14).webp", alt: "Atlantis Project 24", title: "Atlantis Project 24" },
   { src: "/images/dmapt (8).webp", alt: "Atlantis Project 24", title: "Atlantis Project 24" },
